...
typedef union _SMBIOS_MEMORY_MDOULE_SIZE
{
    ...
    UINT8 Value; // SMBIOS_MEMORY_MDOULE_SIZE_VALUE_*
} SMBIOS_MEMORY_MDOULE_SIZE, * PSMBIOS_MEMORY_MDOULE_SIZE;

#define SMBIOS_MEMORY_MDOULE_SIZE_VALUE_NOT_DETERMINABLE ((UINT8)0x7D)
#define SMBIOS_MEMORY_MDOULE_SIZE_VALUE_NOT_ENABLED      ((UINT8)0x7E)
#define SMBIOS_MEMORY_MDOULE_SIZE_VALUE_NOT_INSTALLED    ((UINT8)0x7F)
...
#define SMBIO_PORTABLE_BATTERY_CHEMISTRY_OTHER           ((UINT8)1)
#define SMBIO_PORTABLE_BATTERY_CHEMISTRY_UNKNOWN         ((UINT8)2)
#define SMBIO_PORTABLE_BATTERY_CHEMISTRY_LEAD_ACID       ((UINT8)3)
#define SMBIO_PORTABLE_BATTERY_CHEMISTRY_NICKEL_CADMIUM  ((UINT8)4)
#define SMBIO_PORTABLE_BATTERY_CHEMISTRY_NICKEL_METAL    ((UINT8)5)
#define SMBIO_PORTABLE_BATTERY_CHEMISTRY_LITHIUM_ION     ((UINT8)6)
#define SMBIO_PORTABLE_BATTERY_CHEMISTRY_ZINC_AIR        ((UINT8)7)
#define SMBIO_PORTABLE_BATTERY_CHEMISTRY_LITHIUM_POLYMER ((UINT8)8)
...
#define SMBIOS_SYSTEM_BOOT_STATUS_OPERATING_SYSTEM_DETECTED_FAILURE  ((UINT8)4)
#define SMBIOS_SYSTEM_BOOT_STATUS_USER_REQUESTED_BOOT                ((UINT8)5)
#define SMBIOS_SYSTEM_BOOT_STATUS_SECURITY_VIOLATION                 ((UINT8)6)
#define SMBIOS_SYSTEM_BOOT_STATUS_PREVIOUS_REQUESTED_IMAGE           ((UINT8)7)
