...
STATIC_ASSERT(sizeof(XINPUT_BASE_BUS_INFORMATION) == 16);
...
STATIC_ASSERT(sizeof(XINPUT_CAPABILITIES_EX) == 36);
...
STATIC_ASSERT(sizeof(XINPUT_LISTEN_STATE) == 20);
...
STATIC_ASSERT(sizeof(XINPUT_STATE_EX) == 20);
...
STATIC_ASSERT(sizeof(XUSB_BASE_REQUEST) == 3);
...
STATIC_ASSERT(sizeof(XUSB_INFORMATION) == 12);
...
STATIC_ASSERT(sizeof(XUSB_CAPABILITIES_0101) == 24);
...
STATIC_ASSERT(sizeof(XUSB_CAPABILITIES_0102) == 36);
...
STATIC_ASSERT(sizeof(XUSB_LED_STATE) == 3);
...
STATIC_ASSERT(sizeof(XUSB_STATE_0100) == 20);
...
STATIC_ASSERT(sizeof(XUSB_STATE_0101) == 29);
...
STATIC_ASSERT(sizeof(XUSB_SET_STATE) == 5);
...
STATIC_ASSERT(sizeof(XUSB_BATTERY_INFORMATION_REQUEST) == 4);
...
STATIC_ASSERT(sizeof(XUSB_BATTERY_INFORMATION) == 4);
...
STATIC_ASSERT(sizeof(XUSB_SET_POWEROFF) == 3);
...
STATIC_ASSERT(sizeof(XUSB_AUDIO_DEVICE_INFORMATION) == 7);
...
STATIC_ASSERT(sizeof(XUSB_WAIT_FOR_INPUT_REQUEST) == 4);
...
STATIC_ASSERT(sizeof(XUSB_INFORMATION_EX_REQUEST) == 36);
...
STATIC_ASSERT(sizeof(XUSB_INFORMATION_EX) == 949);
