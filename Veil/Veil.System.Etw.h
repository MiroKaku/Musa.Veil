...
C_ASSERT(sizeof(ETW_GET_DISALLOW_LIST_INFORMATION) == 8);
C_ASSERT(sizeof(ETW_SET_COMPRESSION_SETTINGS_INFORMATION) == 16);
C_ASSERT(sizeof(ETW_GET_COMPRESSION_SETTINGS_INFORMATION) == 8);
C_ASSERT(sizeof(ETW_COMPRESSION_SETTINGS_DATA) == 16);
C_ASSERT(sizeof(ETW_PRIVATE_SESSION_TRACE_REQUEST) == 8);
C_ASSERT(sizeof(ETW_GET_PRIVATE_SESSION_TRACE_HANDLE_INFORMATION) == 8);
C_ASSERT(sizeof(ETW_REGISTER_PRIVATE_SESSION_INFORMATION) == 8);
C_ASSERT(sizeof(ETW_QUERY_SESSION_DEMUX_OBJECT_INFORMATION) == sizeof(HANDLE));
C_ASSERT(sizeof(ETW_SET_PROVIDER_BINARY_TRACKING_INFORMATION) == 8);
C_ASSERT(sizeof(ETW_QUERY_USED_PROCESSOR_COUNT_INFORMATION) == 8);
