...
STATISTATIC_ASSERT(sizeof(WMI_TRACE_PACKET) == sizeof(ULONG), "WMI_TRACE_PACKET must equal sizeof(ULONG)");
...
STATISTATIC_ASSERT(sizeof(WMI_TRACE_MESSAGE_PACKET) == sizeof(ULONG), "WMI_TRACE_MESSAGE_PACKET must equal sizeof(ULONG)");
...
STATISTATIC_ASSERT(sizeof(WMI_BUFFER_HEADER) == 0x48, "WMI_BUFFER_HEADER must equal 0x48");
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, BufferSize) == 0x0);
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, SavedOffset) == 0x4);
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, CurrentOffset) == 0x8);
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, TimeStamp) == 0x10);
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, SlistEntry) == 0x20);
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, ClientContext) == 0x28);
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, State) == 0x2c); // Compression
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, Offset) == 0x30);
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, BufferFlag) == 0x34);
STATISTATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, BufferType) == 0x36);
...
#define CKCL_LOGGER_NAMEA  "Circular Kernel Context Logger"
...
STATISTATIC_ASSERT(PerfInfoMemUsageMax <= (1 << PERFINFO_MM_KERNELMEMORY_USAGE_TYPE_BITS));
...
STATISTATIC_ASSERT(PerfInfoMMStatMax <= (1 << PERFINFO_MM_STAT_TYPE_BITS));
...
STATISTATIC_ASSERT(PERFINFO_CCSWAP_BIT_FULL_TS == (32 - PERFINFO_CCSWAP_BIT_TYPE));

#define PERFINFO_CCSWAP_BIT_SHORT_TS    14
STATISTATIC_ASSERT(PERFINFO_CCSWAP_BIT_SHORT_TS == (16 - PERFINFO_CCSWAP_BIT_TYPE));

#define PERFINFO_CCSWAP_BIT_SMALL_TS    17
STATISTATIC_ASSERT(PERFINFO_CCSWAP_BIT_SMALL_TS ==
...
STATISTATIC_ASSERT(PERFINFO_CCSWAP_BIT_WAIT_TIME ==
...
STATIC_ASSERT(sizeof(ETW_GET_DISALLOW_LIST_INFORMATION) == 8);
STATIC_ASSERT(sizeof(ETW_SET_COMPRESSION_SETTINGS_INFORMATION) == 16);
STATIC_ASSERT(sizeof(ETW_GET_COMPRESSION_SETTINGS_INFORMATION) == 8);
STATIC_ASSERT(sizeof(ETW_COMPRESSION_SETTINGS_DATA) == 16);
STATIC_ASSERT(sizeof(ETW_PRIVATE_SESSION_TRACE_REQUEST) == 8);
STATIC_ASSERT(sizeof(ETW_GET_PRIVATE_SESSION_TRACE_HANDLE_INFORMATION) == 8);
STATIC_ASSERT(sizeof(ETW_REGISTER_PRIVATE_SESSION_INFORMATION) == 8);
STATIC_ASSERT(sizeof(ETW_QUERY_SESSION_DEMUX_OBJECT_INFORMATION) == sizeof(HANDLE));
STATIC_ASSERT(sizeof(ETW_SET_PROVIDER_BINARY_TRACKING_INFORMATION) == 8);
STATIC_ASSERT(sizeof(ETW_QUERY_USED_PROCESSOR_COUNT_INFORMATION) == 8);
